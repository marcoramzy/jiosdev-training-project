...
import { PeopleOldAddDialogComponent } from './people-old-add-dialog/people-old-add-dialog.component';
...
export class PeopleOldComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private peopleService: PeopleOldService,
  ...
  openDialog(): void {
    this.dialogService.openDialog(PeopleOldAddDialogComponent, {
