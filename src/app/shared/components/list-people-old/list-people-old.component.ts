...
import { AppListPeopleOldModel } from './list-people-old.model';
 ...
 */
@Component({
  selector: 'app-list-people-old',
  templateUrl: './list-people-old.component.html',
  styleUrls: ['./list-people-old.component.scss']
})
export class AppListPeopleOldComponent implements OnInit, OnChanges {
  model: AppListPeopleOldModel;
  ...
  private initModel() {
    this.model = new AppListPeopleOldModel();
  }
}
